...
export default function PublicRoutineApp() {
  ...
  const result=useMemo(()=>{
    ...
    if(mode==="teacher") return teacherWeekEntries;
    if(mode==="room") return roomWeekEntries;
    const filtered=mode==="student"
      ? entries.filter(e=>baseSection(sectionOf(e.courseSection))===baseSection(normalized))
      : [];
    const sortDays = days;
